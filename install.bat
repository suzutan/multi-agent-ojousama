@echo off
chcp 65001 >nul 2>&1
title multi-agent-ojousama Installer

echo.
echo   +============================================================+
echo   ^|  [OJOUSAMA] multi-agent-ojousama - WSL Installer                ^|
...
echo   ^|       ユーザー名とパスワードを設定                        ^|
echo   ^|    2. cd /mnt/c/tools/multi-agent-ojousama                      ^|
echo   ^|    3. ./first_setup.sh                                    ^|
echo   ^|                                                            ^|
echo   ^|  Every time you use / 使うたびに:                          ^|
echo   ^|    cd /mnt/c/tools/multi-agent-ojousama                          ^|
