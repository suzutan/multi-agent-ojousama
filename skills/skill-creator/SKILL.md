...
5. 保存
   - パス: ~/.claude/skills/ojousama-{skill-name}/
   - 既存スキルと名前が被らないか確認

## 使用フロー

このスキルはHead MaidがButlerからの指示を受けて使用する。

1. Maidがスキル化候補を発見 → Head Maidに報告
2. Head Maid → Butlerに報告
3. **Butlerが最新仕様をリサーチし、スキル設計を行う**
4. Butlerが人間に承認を依頼（dashboard.md経由）
5. 人間が承認
6. Butler → Head Maidに作成を指示（設計書付き）
7. **Head Maid がこのskill-creatorを使用してスキルを作成**
8. 完了報告

※ Butlerがリサーチした最新仕様に基づいて作成すること。
※ Butlerからの設計書に従うこと。
